...
class _AssignmentsPageState extends State<AssignmentsPage>
  ...
  void initState() {
    ...
    tabController = TabController(
        length: locator<UserProvider>().profile?.roleName == 'user' ? 1 : 2,
        vsync: this);
              ...
              child: TabBarView(
                ...
                isLoadingMyAssignment
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          children:
                              List.generate(myAssignments.length, (index) {
                            return AssignmentWidget.assignmentItem(
                                myAssignments[index]);
                          }),
                        ),
                      ),
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        space(8),
                                        Text(
                                          studentAssignments?.passedCount
                                                  ?.toString() ??
                                              '-',
                                          style: style14Bold(),
                                        ),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        space(8),
                                        Text(
                                          studentAssignments?.failedCount
                                                  ?.toString() ??
                                              '-',
                                          style: style14Bold(),
                                        ),
